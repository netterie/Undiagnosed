...
These \Sexpr{ctab['BED +','AIDS w/in 1yr of HIV']} (\Sexpr{ptab['BED +','AIDS w/in 1yr of HIV']}\% of the sample) cases are highly likely to be false BED+, so let's treat them as BEDm (missing), DD+.
